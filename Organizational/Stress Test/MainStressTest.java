...
public class MainStressTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sumoGuiExe = "\"C:\\Program Files (x86)\\Eclipse\\Sumo\\bin\\sumo-gui.exe\"";
        String sumoCfg = "\"C:\\Users\\yelme\\eclipse-workspace\\Milestone2\\sumo\\Demo2.sumocfg\"";
        ...
        //StressTest vehicle injection
        System.out.println("StressTest 100 vehicles injection");
       for (int i = 1; i <= 100; i++)
        { sim.spawnRandomVehicle(routes);
        	
        }
        System.out.println("Done injecting 100 vehicles");
