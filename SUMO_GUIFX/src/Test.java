...
public class Test extends Application {
    ...
    private Pane mapContent;  // Der eigentliche Inhalt der Map (wird gezoomt)
    ...
    private AnchorPane createTopPane() {
        ...
        zoomSlider.valueProperty().addListener((obs, oldVal, newVal) -> {
            ...
            if (mapContent != null) {
                // Zoom nur den Inhalt, nicht den Container
    ...
    private HBox createInfoLabel(String labelText, String valueId) {
        ...
        value.setId(valueId);
        value.setFont(Font.font("System", FontWeight.BOLD, 11));
    ...
    private Pane createSumoMapPane() {
        // Container mit Clipping - verhindert dass Inhalt über Grenzen ragt
        sumoMapPane = new Pane();
        sumoMapPane.setStyle("-fx-background-color: #1a1a2e;");

        // Clipping-Rectangle das sich an Container-Größe anpasst
        ...
        // Map-Content (dieser wird gezoomt)
        mapContent = new Pane();
        ...
        mapContent.getChildren().addAll(placeholder, infoLabel);
