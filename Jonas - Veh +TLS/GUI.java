...
public class GUI extends JFrame {
    ...
    private void openTlsInspectorSkeleton(String tlsId) {
        ...
        JButton applyDurationBtn = new JButton("Apply Duration");
        JPanel bottom = new JPanel();
        bottom.add(phaseMinus);
        bottom.add(phasePlus);
        bottom.add(applyDurationBtn);
        frame.add(bottom, BorderLayout.SOUTH);


        TlsPhaseCollector collector = new TlsPhaseCollector(controller, tlsId);
        this.tlsPhaseCollector = collector;

        List<Double> xmlDurations = netXmlReader.getDurations(tlsId);
        ...
        applyDurationBtn.addActionListener(e -> collector.applyCurrentPhaseDuration());
